...
&& in_array($extension, $allowedExts))
  ...
  if ($_FILES["file"]["error"] > 0)
    ...
    if (file_exists("displaced/" . $_FILES["file"]["name"]))
      {
  ...
  $sql="INSERT INTO displaced (id, name, age, phone, image , description)
VALUES
...
//echo $random;
//echo "<br>";
echo "<br><img src='displaced/$image' width='100' height='100'><br>" ;
echo "ID = $id"."<br>";
echo "name = $name"."<br>";
echo "age = $age"."<br>";
echo "phone = $phone"."<br>";
